      ...
      <div className="max-w-md w-full space-y-8 bg-gradient-to-br from-dark-800 to-dark-900 p-8 rounded-2xl shadow-2xl border border-primary-900/30 relative z-10">
        <div className="text-center">
          <div className="flex items-center justify-center mb-6">
            ...
            <Shield className="h-8 w-8 text-white -ml-4 relative z-10" />
          </div>
          <h2 className="text-3xl font-heading font-bold text-white mb-2">Akses Admin</h2>
          <p className="text-neutral-400">
            Masuk untuk mengelola toko Artalis Anda
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary w-full py-4 flex items-center justify-center text-lg font-semibold rounded-xl shadow-lg"
          >
            {loading ? (
